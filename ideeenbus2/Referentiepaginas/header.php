<div class="paginaFlexHeader">
    <div class="gridHeader"> 
        <div class="linksGridHeader">
            <?php
                if (isset($_SESSION["gebruikerId"])) {
                    echo '<a href="../Webpaginas/home.php"><img src="../Afbeeldingen/logo/LogoIdeeenbusWit.png" alt="logo Ideeënbus" class="logoIdeeenbus" "></a>';
                } else {
                    echo '<a href="../Webpaginas/start.php"><img src="../Afbeeldingen/logo/LogoIdeeenbusWit.png" alt="logo Ideeënbus" class="logoIdeeenbus" "></a>';
                }
            ?>
        </div>
            ...
            <?php
                if (isset($_SESSION["gebruikerId"])) {
                    echo '<form action="../Webpaginas/zoek.php" method="GET" id="formZoekenId">
                            <input type="text" class="zoekbalk" name="zoekopdracht" id="zoekbalkId" placeholder="Zoek">
                            ...
                            <input type="submit" class="submitZoek" name="submitZoeken" id="submitZoekId" value="Zoek">
                          </form>';
                } else {
        ...
        <div class="rechtsGridHeader">
            <?php
                if (isset($_SESSION["gebruikerId"])) {
                    echo '<p class="displayInline indicatieInlogStatus">'.$_SESSION["gebruikerEmail"].'</p>
                    <a href="../Tussenpaginas/uitloggenNaarStart.php" class="displayInline" id="uitloggenHeaderId">Uitloggen</a>';
                } else {
