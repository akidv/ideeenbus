    ...
    if (!isset($_SESSION["gebruikerProfielstatus"])) {
        ...
        if ($_SESSION["gebruikerProfielstatus"] == 1) {
            ...
            if ($_SESSION["gebruikerProfielstatus"] == 2) {
                $profielwijzigen .= '<a class="linkProfielAanpassen" href="../Tussenpaginas/accupgradensupernaarprofiel.php" 
            onclick="return confirm(\'Weet u zeker dat u een verzoek wilt indienen voor een upgrade tot super-administrator?\')">Verzoek voor upgraden account tot super-administrator</a><br>';
